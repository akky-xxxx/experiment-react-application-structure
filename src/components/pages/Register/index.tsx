...
export const Register: FC = () => {
  ...
  return (
    <MainLayout asideElement={<RemainingCount {...counts} />}>
      ...
      <Heading1>{t("pages.register.pageTitle")}</Heading1>

      <form className={styles.form} onSubmit={handleSubmitHandler}>
        <FieldSet
          descriptionElement={<Description>{t("pages.register.form.description.name")}</Description>}
          fieldNameElement={<FieldName>{t("pages.register.form.label.name")}</FieldName>}
          inputElement={(
        ...
        <FieldSet
          descriptionElement={<Description>{t("pages.register.form.description.email")}</Description>}
          fieldNameElement={<FieldName>{t("pages.register.form.label.email")}</FieldName>}
          inputElement={<TextInput bind={binds.emailBind} />}
          requirementElement={<RequirementLabel isRequired />}
        />

        <FieldSet
          descriptionElement={<Description>{t("pages.register.form.description.note")}</Description>}
          fieldNameElement={<FieldName>{t("pages.register.form.label.note")}</FieldName>}
          inputElement={<TextInput bind={binds.noteBind} />}
          requirementElement={<RequirementLabel isRequired={false} />}
        />

        <button type="submit">{t("pages.register.form.label.submit")}</button>
      </form>
    </MainLayout>
  )
}
